...
public class PuntoBancoGame {
    ...
    public void playRound(char betChoice, int betAmount) {
        ...
        // Overall, the conditional logic is if(if-else), with switch-cases in the interior if.
        ...
        // Score hands and set the score field for each Gambler object for use in roundDisplay.
